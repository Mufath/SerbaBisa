...
def excel_to_csv_page():
    return render_template("upload_tool.html",
        title="Excel ke CSV/JSON",
        description="Ekspor lembar Excel ke CSV atau JSON",
...
def csv_to_excel_page():
    return render_template("upload_tool.html",
        title="CSV/JSON ke Excel",
        description="Buat file .xlsx dari CSV atau JSON",
...
def excel_to_pdf_page():
    return render_template("upload_tool.html",
        title="Excel ke PDF",
        description="Ubah dokumen Excel ke PDF",
...
def merge_page():
    return render_template("upload_tool.html",
        title="Gabung Workbook",
        description="Gabung beberapa file Excel jadi satu",
...
def split_page():
    return render_template("upload_tool.html",
        title="Pisah Sheet",
        description="Ekspor tiap sheet jadi file .xlsx sendiri",
...
def info_page():
    return render_template("upload_tool.html",
        title="Info & Pratinjau",
        description="Lihat daftar sheet dan pratinjau baris",
