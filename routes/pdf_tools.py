...
def merge_page():
    return render_template("upload_tool.html",
        title="Gabung PDF",
        description="Jadiin banyak file PDF ke satu file aja",
        endpoint="/pdf/merge",
        accept=".pdf",
        multiple=True,
        options=[])
...
def split_page():
    return render_template("upload_tool.html",
        title="Pisah PDF",
        description="Potong-potong halaman PDF",
        endpoint="/pdf/split",
        accept=".pdf",
        multiple=False,
        options=[
...
def compress_page():
    return render_template("upload_tool.html",
        title="Kompres PDF",
        description="Kecilin ukuran file PDF biar gampang dikirim",
        endpoint="/pdf/compress",
        accept=".pdf",
        multiple=False,
        options=[
            {"type": "select", "name": "quality", "label": "Tingkat Kompresi",
             "choices": [
                 {"value": "medium", "label": "Standar (Seimbang)"},
                 {"value": "low", "label": "Maksimal (Kualitas Turun, Ukuran Terkecil)"},
...
def rotate_page():
    return render_template("upload_tool.html",
        title="Putar PDF",
        description="Putar arah halaman PDF yang kebalik",
        endpoint="/pdf/rotate",
        accept=".pdf",
        multiple=False,
        options=[
...
def resize_page():
    return render_template("upload_tool.html",
        title="Ubah Ukuran",
        description="Ubah ukuran kertas atau dimensi PDF",
        endpoint="/pdf/resize",
        accept=".pdf",
        multiple=False,
        options=[
...
def page_numbers_page():
    return render_template("upload_tool.html",
        title="Nomor Halaman",
        description="Kasih nomor halaman di PDF-mu",
...
def extract_images_page():
    return render_template("upload_tool.html",
        ...
        description="Ambil semua gambar yang ada di PDF",
...
def protect_page():
    return render_template("upload_tool.html",
        title="Kunci PDF",
        description="Pasang password biar PDF aman",
...
def unlock_page():
    return render_template("upload_tool.html",
        ...
        description="Hilangkan password dari PDF",
        endpoint="/pdf/unlock",
        accept=".pdf",
        multiple=False,
        options=[
...
def compress():
    ...
    # "low" means maximum compression, "high" means minimal compression
    ...
    # Jika kualitas high (kompresi minimal), jangan utak-atik gambar sama sekali!
    if quality != "high":
        processed_xrefs = set()
        for page in doc:
